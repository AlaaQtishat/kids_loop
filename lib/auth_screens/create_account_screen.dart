...
import 'package:kids_loop/feature_screens/main_layout_screen.dart';
import 'package:kids_loop/managers/auth_manager.dart';
import 'package:kids_loop/managers/theme_manager.dart';
import 'package:kids_loop/widgets/custom_text_field.dart';
  ...
  Future<void> _performRegister() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final String newUid = FirebaseAuth.instance.currentUser!.uid;
        OneSignal.login(newUid);
        if (context.mounted) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    ...
                    validator: (val) {
                      if (val == null || val.isEmpty)
                        return "create_account_screen.password_error_empty"
                            .tr();
                      if (val.length < 6)
                        return "create_account_screen.password_error_length"
                            .tr();
                      return null;
                    },
                  ),
